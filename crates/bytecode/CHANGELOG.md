...
## [4.0.0](https://github.com/0xsjn/rEVM/compare/revm-bytecode-v3.0.0...revm-bytecode-v4.0.0) - 2025-04-29

### Added

- *(EOF)* Changes needed for devnet-1 ([#2377](https://github.com/0xsjn/rEVM/pull/2377))
- *(bytecode)* improve legacy bytecode padding ([#2423](https://github.com/0xsjn/rEVM/pull/2423))
...
- cache and use JumpTable::default ([#2439](https://github.com/0xsjn/rEVM/pull/2439))
