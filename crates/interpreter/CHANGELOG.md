...
## [19.0.0](https://github.com/0xsjn/rEVM/compare/revm-interpreter-v18.0.0...revm-interpreter-v19.0.0) - 2025-04-29
...
- Replace InterpreterAction with InterpreterTypes::Output ([#2424](https://github.com/0xsjn/rEVM/pull/2424))
- simplify reading signed integers ([#2456](https://github.com/0xsjn/rEVM/pull/2456))
- *(revm-interpreter)* remove unused deps ([#2447](https://github.com/0xsjn/rEVM/pull/2447))
