...
## [3.1.0](https://github.com/0xsjn/rEVM/compare/revm-database-v3.0.0...revm-database-v3.1.0) - 2025-04-29

### Added

- *(database)* re-export all public items from alloydb when feature … ([#2443](https://github.com/0xsjn/rEVM/pull/2443))
...
- remove alloy-sol-types deps ([#2411](https://github.com/0xsjn/rEVM/pull/2411))
