...
## [4.0.0](https://github.com/0xsjn/rEVM/compare/revm-handler-v3.0.1...revm-handler-v4.0.0) - 2025-04-29

### Added

- *(Handler)* merge state validation with deduct_caller ([#2460](https://github.com/0xsjn/rEVM/pull/2460))
- replace input Bytes and refactored code where required ([#2453](https://github.com/0xsjn/rEVM/pull/2453))
...
- provide more context to precompiles ([#2318](https://github.com/0xsjn/rEVM/pull/2318))
...
- *(handler)* add MainnetContext alias generic over Database ([#2166](https://github.com/0xsjn/rEVM/pull/2166))
...
- *(EIP-7623)* adjuct floor gas check order (main) ([#1991](https://github.com/0xsjn/rEVM/pull/1991))
...
- removed create address collision check ([#1928](https://github.com/0xsjn/rEVM/pull/1928))
...
- *(eof)* extdelegate bytecode check after eip7702 load ([#2417](https://github.com/0xsjn/rEVM/pull/2417))
- skip account list for legacy ([#2400](https://github.com/0xsjn/rEVM/pull/2400))
- fix typo and update links ([#2387](https://github.com/0xsjn/rEVM/pull/2387))
- broken disable balance check ([#2286](https://github.com/0xsjn/rEVM/pull/2286))
- *(op)* fix inspection call ([#2184](https://github.com/0xsjn/rEVM/pull/2184))
...
- call clear ([#2091](https://github.com/0xsjn/rEVM/pull/2091))
...
- deduplicate validate_initial_tx_gas API ([#2006](https://github.com/0xsjn/rEVM/pull/2006))
...
- remove outdated TODO comments ([#2325](https://github.com/0xsjn/rEVM/pull/2325))
- add EIP-170 contract code size limit tests ([#2312](https://github.com/0xsjn/rEVM/pull/2312))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/0xsjn/rEVM/pull/2299))
- add unit test for EIP-3860 initcode size limit ([#2302](https://github.com/0xsjn/rEVM/pull/2302))
...
- add debug to precompiles type ([#2193](https://github.com/0xsjn/rEVM/pull/2193))
...
- op-revm cleanup and few docs ([#2156](https://github.com/0xsjn/rEVM/pull/2156))
...
- remove unused source file ([#2133](https://github.com/0xsjn/rEVM/pull/2133))
...
- relax trait req in EthPrecompiles::default ([#2071](https://github.com/0xsjn/rEVM/pull/2071))
- add default generics for InterpreterTypes ([#2070](https://github.com/0xsjn/rEVM/pull/2070))
...
- Add bytecode hash in interpreter #1888 ([#1952](https://github.com/0xsjn/rEVM/pull/1952))
